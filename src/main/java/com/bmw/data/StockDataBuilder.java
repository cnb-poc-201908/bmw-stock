...
public class StockDataBuilder {
	...
	private static String[] vehicleModelConfigs = new String[] { "NU15A0", "HN21_Z1LX", "GY01_Z3VZ", "AY97A7",
			"VA96B8" };
	private static String[] vehicleModels = new String[] { "523Li Luxury", "730Li", "X5 M GY01 E70 M 07/09", "318i",
			"320i Vantage Xenon" };

	private static String[] colors = new String[] { "Alpine White", "Black Sapphire Metallic", "Steel Blue",
	...
	private static String[] statusCodes = new String[] { "0", "50", "55", "60", "70", "75", "80", "84", "88", "89",
